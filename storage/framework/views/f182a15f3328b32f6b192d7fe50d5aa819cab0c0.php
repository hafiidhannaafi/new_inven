        ...
        <div class="row align-items-top">
            <div class="col-lg-14">
                ...
                <div class="card">
                    <div class="card-body">
                        <center>
                            <h5 class="card-title">Riwayat Peminjaman <?php echo e(auth()->user()->name); ?></h5>
                            <center>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tugas_akhir\invennnn\resources\views/staff/riwayat.blade.php ENDPATH**/ ?>