                                ...
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $peminjaman; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ?>
                                            <?php if($status->status_konfirmasis_id == 4 || $status->status_konfirmasis_id == 5): ?>
                                            <?php else: ?>
                                                ...
                                                <td>
                                                    <a href="/detailpengajuan/<?php echo e($data->kode_peminjaman); ?>"
                                                ...
                                                <td>
                                                    <!--STATUS DI SETUJUI -->
                                                    <?php if($status->status_konfirmasis_id == 1): ?>
                                                        <a href="/status_setuju/<?php echo e($data->kode_peminjaman); ?>"
                                                            type="button" class="btn btn-success btn-sm"><i
                                                                class="bi bi-check-lg"></i></a>

                                                        <a href="/status_ditolak/<?php echo e($data->kode_peminjaman); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tugas_akhir\invennnn\resources\views/kepalaunit/pengajuan.blade.php ENDPATH**/ ?>