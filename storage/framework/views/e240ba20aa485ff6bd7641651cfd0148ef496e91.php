                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php $__currentLoopData = $peminjaman; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-md-4 label "> 4. Tujuan </div>
                                    <div class="col-lg-7 col-md-8"> : <?php echo e($p->tujuan); ?> </div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-5 col-md-4 label "> 5. Tanggal pengajuan</div>
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-md-4 label "> 6. Tanggal peminjaman </div>
                                    <div class="col-lg-7 col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-md-4 label "> 7. Tanggal pengembalian</div>
                                    <div class="col-lg-7 col-md-8">
                                        <td> : <?php echo date('d F Y', strtotime($p->tgl_kembali)); ?> </td>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-5 col-md-4 label "> 8. Surat Pengantar</div>
                            ...
                            <p class="small fst-italic">note : <br>- tekan tombol ajukan untuk pengajuan peminjaman
                                <br></br>
                            <p>
                                <a href="/peminjaman/peminjaman "
                                    style="float :left; background-color:   #012970; color:#FFFFFF" button type="button"
                                    class="btn btn-sm">Kembali</a>


                                <!--STATUS PENGAJUAN  -->
                                <a href="/status_pengajuan/<?php echo e($p->kode_peminjaman); ?>" class="btn btn btn-sm center-block"
                                    style="float :right; background-color:   #012970; color:#FFFFFF" button type="button">
                                    Ajukan</a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tugas_akhir\invennnn\resources\views/peminjaman/konfirmasi.blade.php ENDPATH**/ ?>