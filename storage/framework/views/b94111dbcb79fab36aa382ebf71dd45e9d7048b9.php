        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Laporan Data Aset Perlengkapan</h5>

                            <form action="/filterasetperlengkapan" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="row mb-3">
                    ...
                    <?php if(isset($data)): ?>
                        <div class=" ">
                            <div class="card-body">
                                <h5 class="card-title">Laporan Data Aset Perlengkapan</h5>
                                <a href="/laporanasetperlengkapan/<?php echo e($startDate); ?>/<?php echo e($endDate); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tugas_akhir\invennnn\resources\views/laporan/perlengkapan.blade.php ENDPATH**/ ?>