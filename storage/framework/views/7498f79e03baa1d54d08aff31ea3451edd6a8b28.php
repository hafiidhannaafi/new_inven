                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/filterpeminjaman" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="row mb-3">
                    ...
                    <?php if(isset($data)): ?>
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="/laporanpeminjaman/<?php echo e($startDate); ?>/<?php echo e($endDate); ?>"
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td> <?php echo e($data->jenis_peminjaman); ?></td>
                                                <td> <?php echo e($data->tgl_pengajuan); ?></td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\tugas_akhir\invennnn\resources\views/laporan/peminjaman.blade.php ENDPATH**/ ?>