                        ...
                        <div class="card-body">
                            ...
                            @foreach ($peminjaman as $p)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-8"> : {{ $p->tujuan }} </div>
                                </div>
                            ...
                            <p>
                                ...
                                <!--STATUS PENGAJUAN  -->
                                <a href="/status_pengajuan/{{ $p->kode_peminjaman }}" class="btn btn btn-sm center-block"
                                    style="float :right; background-color:   #012970; color:#FFFFFF" button type="button">
                                    Ajukan</a>

                                {{-- <!--STATUS PEMBATALAN-->
                            <a href="/status_batal/{{ $p->kode_peminjaman }}" type="button" class="btn btn btn-sm"
                                style="float :right; background-color:   #012970; color:#FFFFFF" button type="button">
                                cetak</a> --}}
