                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('create') }}" method="POST"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="hidden" value="3" name="jenis_asets_id" id="validationTooltip02"
                                        class="form-control" required>
                                    <div class="invalid-feedback">
                                        Harus di isi
                                    </div>
                      ...
                      Harus di isi
                                ...
                                <div class="row mb-3">
                                    <label for="validationTooltip04" class="col-sm-2 col-form-label">Beban
                                        Penyusutan</label>
                                    <div class="col-sm-10">
                                        <input type="text" id="validationTooltip04" name="beban_penyusutan"
                                            class="form-control" required>
                                        <div class="invalid-feedback">
                                            Harus di isi
                                        </div>
                                ...
                                <div class="row mb-3">
                                    <label for="validationTooltip04" class="col-sm-2 col-form-label">Nilai
                                        Buku</label>
                                    <div class="col-sm-10">
                                        <input type="text" id="validationTooltip04" name="nilai_buku"
                                            class="form-control" required>
                                        <div class="invalid-feedback">
                                            Harus di isi
                                        </div>
