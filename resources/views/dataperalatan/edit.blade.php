            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/data-peralatan/update/{{ $inputbarang->id }}" method="POST"
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="invalid-feedback">
                      Harus di isi
                                ...
                                <div class="row mb-3">
                                    <label for="validationTooltip04" class="col-sm-2 col-form-label">Beban
                                        Penyusutan</label>
                                    <div class="col-sm-10">
                                        <input type="text" value="{{ $inputbarang->beban_penyusutan }}"
                                            id=" " name="beban_penyusutan" class="form-control" required>
                                        <div class="invalid-feedback">
                                            Harus di isi
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <label for="validationTooltip04" class="col-sm-2 col-form-label">Nilai
                                        Buku</label>
                                    <div class="col-sm-10">
                                        <input type="text" value="{{ $inputbarang->nilai_buku }}" id=" "
                                            name="nilai_buku" class="form-control" required>
                                        <div class="invalid-feedback">
                                            Harus di isi
                                        </div>
                                    </div>
